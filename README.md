...
You can link the CLI against a different version of the Casedev Go SDK
...
```bash
./scripts/link ../path/to/githubcomcasemarkcasedevgo-go
```

If you run the link script without any arguments, it will default to `../githubcomcasemarkcasedevgo-go`.
